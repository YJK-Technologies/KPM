...
const VendorProductTable = ({ open, handleClose, handlePurchaseData, apiPath }) => {
            ...
            <div className="modal-dialog modal-dialog-centered modal-lg mt-0" role="document">
              <div className="modal-content rounded-4 shadow-lg">
                <div className="modal-header">
                  <h5 className="modal-title fw-bold fs-3">{apiPath === "PurchaseOrderSearchData" ? "Purchase Order Help" : "Purchase Help"}</h5>
