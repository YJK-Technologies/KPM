      ...
      <div className="border p-3">
              ...
              {detailData.length > 0 && (
                <>
                  ...
                  <td style={{ textAlign: "right" }}>
                    {parseFloat(detailData[detailData.length - 1].bill_rate || 0).toFixed(2)}
                  </td>
                </>
              )}
            </tr>
        ...
        <div className="row align-items-end mt-3">
          ...
          <div className="col-5 text-end small">
            ...
            <h6 className="fw-bold">Net Amount: ₹ {parseFloat(detailData[detailData.length - 1].bill_rate || 0).toFixed(2)}</h6>
          </div>
        </div>
        ...
        <div className="small">
          <div className="d-flex justify-content-between mb-1">
            ...
            <span className="fw-bold">2730.00</span>
          </div>
          {/* <div className="d-flex justify-content-between mb-1">
          ...
          <div className="d-flex justify-content-between mb-1">
            ...
            <span className="fw-bold">2535.00</span>
          </div>
        </div>
