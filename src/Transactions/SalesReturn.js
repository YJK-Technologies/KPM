...
import SalesPopup from '../Transactions/Popups/SalesReturnPopup';
import SalesReturnPopup from '../Transactions/Popups/SalesReturnViewPopup';
...
const VendorProductTable = () => {
  ...
  const SalesreturnItemAmountCalculation = async (params) => {
    if (params.data.billQty >= params.data.returnQty) {
      ...
      // toast.warning("Bill quantity should be greater than or equal to return quantity. Skipping calculation.");
    }
  };
  ...
  const handleSaveButtonClick = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success("Sales Return Data inserted Successfully")
  ...
  const TransactionStatus = async (returnNo) => {
    try {
      ...
      console.error("Error executing API calls:", err.message);
    ...
    <div className="container-fluid ">
      ...
      <div className="card shadow-lg border-0 p-3 rounded-5 mb-2 " style={{ height: "auto" }}>
        <div className="d-flex justify-content-between">
          <div className='d-flex justify-content-start'> <h4 className="mb-5 fw-semibold text-dark fs-2 fw-bold">Sales Return</h4> </div>
          <div className='d-flex justify-content-end row'>
            <div className='desktopbuttons'>
              <div className='d-flex justify-content-end row me-4'>
                {buttonsVisible && ['add', 'all permission'].some(permission => salesReturnPermission.includes(permission)) && (
                  <div className='col-md-2 mt-1 mb-5 me-3' ><a className='border-none text-success p-1' style={{ cursor: "pointer" }} onClick={handleSaveButtonClick} title='Save'><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-floppy2" viewBox="0 0 16 16">
                ...
                {/* {buttonsVisible && ['view', 'all permission'].some(permission => salesReturnPermission.includes(permission)) && (
                  <div className='col-md-2 mt-1 mb-5' ><a className='border-none text-dark p-1' style={{ cursor: "pointer" }} onClick={generateReport} title='Print'><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-file-earmark-text-fill" viewBox="0 0 16 16">
                ...
                {showExcelButton && (
                  <div className='col-md-2 mt-1 mb-5' ><a className='border-none text-success p-1' style={{ cursor: "pointer" }} onClick={handleExcelDownload} title='Excel'><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-file-earmark-excel-fill" viewBox="0 0 16 16">
                  <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1M5.884 6.68 8 9.219l2.116-2.54a.5.5 0 1 1 .768.641L8.651 10l2.233 2.68a.5.5 0 0 1-.768.64L8 10.781l-2.116 2.54a.5.5 0 0 1-.768-.641L7.349 10 5.116 7.32a.5.5 0 1 1 .768-.64"/>
                </svg>
                  </a>
                  </div>
                )}
                <div className='col-md-2 mt-1 mb-5' ><a className='border-none text-dark p-1' style={{ cursor: "pointer" }} onClick={handleReload} title='Reload'><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-printer-fill" viewBox="0 0 16 16">
                ...
                <div className="col-auto position-relative" ref={dropdownRef}>
                  ...
                  {opens && (
                    <div className="dropdown-menu show mt-2 custom-dropdown p-2" style={{ display: 'block' }}>
                      {buttonsVisible && ['add', 'all permission'].some(permission => salesReturnPermission.includes(permission)) && (
                        <div className='col-md-2 mt-1 mb-3' ><a className='border-none text-success p-1' style={{ cursor: "pointer" }} onClick={handleSaveButtonClick} title='Save'><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-floppy2" viewBox="0 0 16 16">
                          <path d="M1.5 0h11.586a1.5 1.5 0 0 1 1.06.44l1.415 1.414A1.5 1.5 0 0 1 16 2.914V14.5a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 14.5v-13A1.5 1.5 0 0 1 1.5 0M1 1.5v13a.5.5 0 0 0 .5.5H2v-4.5A1.5 1.5 0 0 1 3.5 9h9a1.5 1.5 0 0 1 1.5 1.5V15h.5a.5.5 0 0 0 .5-.5V2.914a.5.5 0 0 0-.146-.353l-1.415-1.415A.5.5 0 0 0 13.086 1H13v3.5A1.5 1.5 0 0 1 11.5 6h-7A1.5 1.5 0 0 1 3 4.5V1H1.5a.5.5 0 0 0-.5.5m9.5-.5a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5z" />
                        </svg>
                        </a>
                        </div>
                      ...
                      {/* {buttonsVisible && ['view', 'all permission'].some(permission => salesReturnPermission.includes(permission)) && (
                        <div className='col-md-2 mt-1 mb-3' ><a className='border-none text-dark p-1' style={{ cursor: "pointer" }} onClick={generateReport} title='Print'><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-file-earmark-text-fill" viewBox="0 0 16 16">
                          <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1M4.5 9a.5.5 0 0 1 0-1h7a.5.5 0 0 1 0 1zM4 10.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m.5 2.5a.5.5 0 0 1 0-1h4a.5.5 0 0 1 0 1z" />
                        </svg>
                        </a>
                        </div>
                      ...
                      {showExcelButton && (
                        <div className='col-md-2 mt-1 mb-3' ><a className='border-none text-success p-1' style={{ cursor: "pointer" }} onClick={handleExcelDownload} title='Excel'><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-file-earmark-excel-fill" viewBox="0 0 16 16">
                        <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1M5.884 6.68 8 9.219l2.116-2.54a.5.5 0 1 1 .768.641L8.651 10l2.233 2.68a.5.5 0 0 1-.768.64L8 10.781l-2.116 2.54a.5.5 0 0 1-.768-.641L7.349 10 5.116 7.32a.5.5 0 1 1 .768-.64"/>
                      </svg>
                        </a>
                        </div>
                      )}
                      <div className='col-md-2 mt-1 mb-3' ><a className='border-none text-dark p-1' style={{ cursor: "pointer" }} onClick={handleReload} title='Reload'><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-printer-fill" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M8 3a5 5 0 1 0 4.546 2.914.5.5 0 0 1 .908-.417A6 6 0 1 1 8 2z" />
                        <path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466" />
                      </svg>
                      </a>
        ...
        <div className="row">
          ...
          <div className="col-md-3 mb-2">
            <label className={`fw-bold ${error && !billNo ? 'text-danger' : ''}`}>Bill No{!showAsterisk && <span className="text-danger">*</span>}</label>
            <div className="position-relative">
              <input
                type="text"
          ...
          <div className="col-md-3 mb-2">
            <label className={`fw-bold ${authError && !return_no ? 'text-danger' : ''}`}>Return No{showAsterisk && <span className="text-danger">*</span>}</label>
            <div className="position-relative">
              <input
                type="text"
                className="form-control pe-5"
          ...
          <div className="col-md-3 mb-2">
            <label className={`fw-bold ${error && !return_date ? 'text-danger' : ''}`}>Return Date{!showAsterisk && <span className="text-danger">*</span>}</label>
            <div className="position-relative">
              <input
                className="form-control pe-5"
                type="date"
          ...
          <div className="col-md-3 mb-2">
            <label className={`fw-bold ${error && !return_person ? 'text-danger' : ''}`}>Return Person{!showAsterisk && <span className="text-danger">*</span>}</label>
            <div className="position-relative">
              <input type="text"
                className="form-control pe-5"
                id="retper"
                ...
                value={return_person}
                onChange={(e) => {
                  setreturn_person(e.target.value);
                }}
                autoComplete="off"
                ref={retperson}
          ...
          <div className="col-md-3 mb-2">
            <label className={`fw-bold ${error && !return_reason ? 'text-danger' : ''}`}>Return Reason{!showAsterisk && <span className="text-danger">*</span>}</label>
            <div className="position-relative">
              <input type="text"
                className="form-control pe-5"
                id="retreason"
          ...
          <div className="card shadow-lg border-0 p-3 rounded-5 mb-2" style={{ height: "auto" }}>
                <div className='row '>
          <div className="col-md-3 mb-2">
            <label className="fw-bold">Total Sales</label>
            <div className="position-relative">
              <input
                type="text"
                className="form-control pe-5"
        ...
        <div className='row ms-2 mt-2'>
          <div className='d-flex justify-content-between'>
            <div className='d-flex justify-content-start'>
              <button title='Item Details' onClick={() => handleToggleTable('myTable')} className={`salesbutton col-md-8 col-md-2 "toggle-btn" ${activeTable === 'myTable' ? 'active' : ''}`} style={{ borderTopLeftRadius: "20px", borderTopRightRadius: "20px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", }}> Item Details</button>
              <button title='Tax Details' onClick={() => handleToggleTable('tax')} className={`salesbutton col-md-8 col-md-2 "toggle-btn" ${activeTable === 'tax' ? 'active' : ''}`} style={{ borderTopLeftRadius: "20px", borderTopRightRadius: "20px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", }}> Tax Details</button>
            </div>
          </div>
        </div>
        ...
        <>
          <SalesPopup open={open} handleClose={handleClose} handleData={handleData} />
          <SalesReturnPopup open={open1} handleClose={handleClose} handleDataView={handleDataView} />
        </>
