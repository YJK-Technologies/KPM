...
const VendorProductTable = () => {
  ...
  useEffect(() => {
    const company_code = sessionStorage.getItem('selectedCompanyCode');
    fetch(`${config.apiBaseUrl}/CategoryFetch`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
    ...
    <div className="container-fluid sidenav">
      ...
      <div className="card shadow-lg border-0 p-3  rounded-5" >
        <div className="d-flex justify-content-between">
          <div className='d-flex justify-content-start'> <h4 className="mb-5 fw-semibold text-dark fs-2 fw-bold">{mode === "update" ? 'Update Item' : ' Add Item'}</h4> </div>
        ...
        <div className="row">
          <div className="col-md-3 mb-2">
            <label className={`fw-bold ${error && !Item_code ? 'text-danger' : ''}`}>Code<span className="text-danger">*</span></label>
            <div className="">
          ...
          <div className="col-md-3 mb-2">
            <label className='fw-bold'>Without Tax</label>
            <input
              type="text"
              className="form-control"
              id="Iwotax"
              ...
              onChange={(e) => {
                const onlyNums = e.target.value.replace(/\D/, ''); // remove non-numeric
                if (onlyNums.length <= 5) {
                  setItem_Last_salesRate_ExTax(onlyNums);
                }
              }}
              maxLength={20}
              ref={withouttax}
          ...
          <div className="col-md-3 mb-2">
            <label className='fw-bold'>With Tax</label>
            <input
              type="text"
              className="form-control"
              id="Iwtax"
              ...
              onChange={(e) => {
                const onlyNums = e.target.value.replace(/\D/, ''); // remove non-numeric
                if (onlyNums.length <= 5) {
                  setItem_Last_salesRate_IncludingTax(onlyNums);
                }
              }}
              maxLength={20}
              ref={withtax}
          ...
          <div className="col-md-3 mb-2">
            <label className={`fw-bold ${error && !Item_std_purch_price ? 'text-danger' : ''}`}>Purchase Price<span className="text-danger">*</span></label>
            <input
              type="text"
              className="form-control"
              id="Ipprice"
              ...
              onChange={(e) => {
                const onlyNums = e.target.value.replace(/\D/, ''); // remove non-numeric
                if (onlyNums.length <= 5) {
                  setItem_std_purch_price(onlyNums);
                }
              }}
              maxLength={20}
              ref={purchaseprice}
          ...
          <div className="col-md-3 mb-2">
            <label className={`fw-bold ${error && !Item_std_sales_price ? 'text-danger' : ''}`}>Sales Price<span className="text-danger">*</span></label>
            <input
              type="text"
              className="form-control"
              id="Isprice"
          ...
          <div className="col-md-3 mb-2">
            <label className={`fw-bold ${error && !MRPprice ? 'text-danger' : ''}`}>MRP Price<span className="text-danger">*</span></label>
            <input
              type="text"
              className="form-control"
              id="Isprice"
