...
const VendorProductTable = () => {
    ...
    if (rowIndex !== -1) {
      ...
      setEditedData((prevData) => {
        const existingIndex = prevData.findIndex(
          (item) => item.attributeheader_code === params.data.attributeheader_code && item.attributedetails_code === params.data.attributedetails_code
        );
  ...
  const hasPermission = (perm) =>
    attributePermission.includes(perm) || attributePermission.includes('all permission');
    ...
    <div className="container-fluid ">
      ...
      <div className="card shadow-lg border-0 p-3 rounded-5 " style={{ height: "auto" }}>
        <div className="d-flex justify-content-between">
          <div className='d-flex justify-content-start'> <h4 className="mb-5 fw-semibold text-dark fs-2 fw-bold">Attribute</h4> </div>
          <div className="desktopbuttons">
            <div className='d-flex justify-content-end row'>
              {['add', 'all permission'].some(permission => attributePermission.includes(permission)) && (
                <div className='col-md-2 mt-1 me-0 mb-5' ><a className='border-none text-dark p-1' title="Add Attribute" onClick={handleClick} style={{ cursor: "pointer" }}><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-patch-plus-fill" viewBox="0 0 16 16">
        ...
        <div className="row">
          ...
          <div className="col-md-3 mb-2">
            <label className='fw-bold'>Sub Code</label>
            <input
              type="text"
              className="form-control"
              placeholder=""
          ...
          <div className="col-md-3 mb-2">
            <label className='fw-bold'>Detail Name</label>
            <input
              type="text"
              className="form-control"
              placeholder=""
