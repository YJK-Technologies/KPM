...
const VendorProductTable = () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const newRows = searchData.map((matchedItem) => ({
          ...
          sales_type: matchedItem.sales_type,
          pay_type: matchedItem.pay_type,
          bill_rate: matchedItem.bill_rate,
          tax_amt: matchedItem.tax_amt,
  ...
  const transformRowData = (data) => {
    return data.map(row => ({
      ...
      "Party Code": row.customer_code.toString(),
      "Sales Type": row.sales_type.toString(),
      "Pay Type": row.pay_type.toString(),
      "Sold Amount": row.bill_rate,
    ...
    <div className="container-fluid ">
      ...
      <div className="card shadow-lg border-0 p-3 rounded-5 " >
        <div className="d-flex justify-content-between">
          <div className='d-flex justify-content-start'> <h4 className=" fw-semibold text-dark fs-2 fw-bold">Sales Analysis</h4> </div>
